...
const educationData: {
...
}[] = [
  {
    ...
    description: "Bachelor of Science in Computer Science, focusing on computer science fundamentals including algorithms, data structures, and programming languages. GPA: 3.1 / 4.",
    position: "left",
  },
  {
    id: 2,
    ...
    description: "I completed a Front-End Developer course where I gained hands-on experience with HTML, CSS, Bootstrap, JavaScript, SASS, and React to build responsive and dynamic web applications.",
    position: "right",
  },
];
...
const experienceData: {
...
}[] = [
  {
    ...
    description: "Undertook a rigorous one-month training in frontend development, gaining hands-on experience in HTML, CSS, JavaScript, React, and Material UI for building responsive and dynamic interfaces.",
    position: "left",
  },
  {
    id: 2,
    ...
    description: "Completed a one-month training in full-stack development with the MEAN stack, focusing on building RESTful APIs, developing Angular applications, and managing MongoDB databases.",
    position: "right",
  },
];
...
const TimelineItem = ({
  ...
  <motion.div
    ...
    viewport={{ once: true }}
    className={`relative w-full ${position === 'left' ? 'pr-0 md:pr-[50%]' : 'pl-0 md:pl-[50%]'} py-4`}
  >
    <div className={`relative p-6 rounded-xl bg-gray-800 border border-gray-700 shadow-lg ${position === 'left' ? 'md:mr-6' : 'md:ml-6'}`}>
      ...
      <div className={`absolute top-6 hidden md:block ${position === 'left' ? 'right-[-8px]' : 'left-[-8px]'} w-4 h-4 rotate-45 bg-gray-800 border-r border-b border-gray-700`}></div>
    </div>
  </motion.div>
);
